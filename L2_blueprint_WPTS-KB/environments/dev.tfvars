...
knowledgebaseList = [
   {
     ...
     knowledgebaseLocations = {
       ScDc-CIO-Chatbot-WPTS-HW-EN-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-HW-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScDc-CIO-Chatbot-WPTS-HW-FR-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-HW-FR-KB.json"
      }
   },
   {
     languageCode = "EN",
     deploy = true
     knowledgebaseLocations = {
       ScDc-CIO-Chatbot-WPTS-SW-EN-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-SW-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScDc-CIO-Chatbot-WPTS-SW-FR-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-SW-FR-KB.json"
      }
   },
   {
     languageCode = "EN",
     deploy = true
     knowledgebaseLocations = {
       ScDc-CIO-Chatbot-WPTS-PP-EN-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-PP-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScDc-CIO-Chatbot-WPTS-PP-FR-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-PP-FR-KB.json"
      }
   },
   {
     languageCode = "EN",
     deploy = true
     knowledgebaseLocations = {
       ScDc-CIO-Chatbot-WPTS-ITPro-EN-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-ITPro-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScDc-CIO-Chatbot-WPTS-ITPro-FR-KB = "knowledgebases/ScDc-CIO-Chatbot-WPTS-ITPro-FR-KB.json"
      }
   }
]
