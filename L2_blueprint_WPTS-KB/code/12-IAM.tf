...
module "RG_AADSGs_HW" {
  ...
  azuread_groupsMap = {
    Contributors = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_HW_KB.name}_Contributors"
      owners            = var.L2_RG_RBAC.contributorNames
    },
    Owners = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_HW_KB.name}_Owners"
...
resource "azurerm_role_assignment" "L2_RG_Owner_HW" {
  scope                = local.resource_groups_L2.WPTS_HW_KB.id
...
module "RG_AADSGs_SW" {
  ...
  azuread_groupsMap = {
    Contributors = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_SW_KB.name}_Contributors"
      owners            = var.L2_RG_RBAC.contributorNames
    },
    Owners = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_SW_KB.name}_Owners"
      owners            = var.L2_RG_RBAC.ownerNames
    }
  }
}
...
resource "azurerm_role_assignment" "L2_RG_Owner_SW" {
  scope                = local.resource_groups_L2.WPTS_SW_KB.id
  role_definition_name = "Owner"
...
module "RG_AADSGs_ITPro" {
  ...
  azuread_groupsMap = {
    Contributors = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_ITPro_KB.name}_Contributors"
      owners            = var.L2_RG_RBAC.contributorNames
    },
    Owners = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_ITPro_KB.name}_Owners"
      owners            = var.L2_RG_RBAC.ownerNames
    }
  }
}
...
resource "azurerm_role_assignment" "L2_RG_Owner_ITPro" {
  scope                = local.resource_groups_L2.WPTS_ITPro_KB.id
  role_definition_name = "Owner"
...
module "RG_AADSGs_PP" {
  ...
  azuread_groupsMap = {
    Contributors = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_PP_KB.name}_Contributors"
      owners            = var.L2_RG_RBAC.contributorNames
    },
    Owners = {
      userDefinedString = "${var.group}_${var.project}_${local.resource_groups_L2.WPTS_PP_KB.name}_Owners"
      owners            = var.L2_RG_RBAC.ownerNames
    }
  }
}
...
resource "azurerm_role_assignment" "L2_RG_Owner_PP" {
  scope                = local.resource_groups_L2.WPTS_PP_KB.id
  role_definition_name = "Owner"
