...
knowledgebaseList = [
  {
    ...
    knowledgebaseLocations = {
      ScDc-CIO-Chatbot-GWCC-EN-KB = "knowledgebases/ScDc-CIO-Chatbot-GWCC-EN-KB.json"
    },
  },
  {
    languageCode = "FR"
    deploy       = true
    knowledgebaseLocations = {
      ScDc-CIO-Chatbot-GWCC-FR-KB = "knowledgebases/ScDc-CIO-Chatbot-GWCC-FR-KB.json"
    }
  }
]
