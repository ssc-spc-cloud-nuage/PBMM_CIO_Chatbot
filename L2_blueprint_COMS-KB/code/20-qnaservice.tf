...
module "Chatbot-COMS-EN-KB" {
  ...
  location                  = local.resource_groups_L2.COMS_KB.location
  cognitiveServicesLocation = var.cognitiveServicesLocation
  resourceGroupName         = local.resource_groups_L2.COMS_KB.name
