...
knowledgebaseList = [
   {
     ...
     knowledgebaseLocations = {
       ScSc-CIO-Chatbot-COMS-EN-KB= "knowledgebases/ScDc-CIO-Chatbot-COMS-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScSc-CIO-Chatbot-COMS-FR-KB= "knowledgebases/ScDc-CIO-Chatbot-COMS-FR-KB.json"
      }
   }
]
