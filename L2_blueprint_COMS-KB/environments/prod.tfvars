...
knowledgebaseList = [
   {
     ...
     knowledgebaseLocations = {
       ScPc-CIO-Chatbot-COMS-EN-KB= "knowledgebases/ScPc-CIO-Chatbot-COMS-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScPc-CIO-Chatbot-COMS-FR-KB= "knowledgebases/ScPc-CIO-Chatbot-COMS-FR-KB.json"
      }
   }
]
