...
knowledgebaseList = [
   {
     ...
     knowledgebaseLocations = {
       ScDc-CIO-Chatbot-Telcom-EN-KB= "knowledgebases/ScDc-CIO-Chatbot-Telcom-EN-KB.json"       
     },
   },
   {
      languageCode = "FR"
      deploy = true
      knowledgebaseLocations = {
        ScDc-CIO-Chatbot-Telcom-FR-KB= "knowledgebases/ScDc-CIO-Chatbot-Telcom-FR-KB.json"
      }
   }
]
