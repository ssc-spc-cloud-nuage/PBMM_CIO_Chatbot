...
L2_RG_RBAC = {
  contributorNames = [
    "Mario.Francoeur@ssc-spc.gc.ca",
    "Stephane.Proulx5@ssc-spc.gc.ca",
    "Kevin.Earle@ssc-spc.gc.ca",
    "Kevin.Ogilvie@ssc-spc.gc.ca",
    "David.Kuta@ssc-spc.gc.ca",
    "Amanda.Hammond@ssc-spc.gc.ca",
    "Luc.Theberge@ssc-spc.gc.ca"
  ]
  ownerNames = [
